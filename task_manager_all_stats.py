...
#••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
       ...
       #__________________________________________________________________________________________
        ...
        print(f'Total num of completed tasks is {total_num_completed_tasks}')
        print(f'Total num of uncompleted tasks is {total_num_uncompleted_tasks}')
        print(f'Percentage of uncomplete tasks is {percentage_uncomplete_tasks}%.')
        print(f'The percentage of tasks that are overdue is {percentage_overdue_tasks}%')
        print(f'The total number of overdue tasks is {total_overdue_tasks}')
        print(f'The total number of overdue and uncomplete tasks is {total_overdue_uncomplete_tasks}')
        #__________________________________________________________________________________________
...
The total number of overdue and uncomplete tasks is {total_overdue_uncomplete_tasks}''')
        ...
        total_num_of_tasks = len(total_task_list)
        #__________________________________________________________________________________________
        print(f'\nTotal number of users is {total_num_of_users}.')
        print(f'Total number of tasks is {total_num_of_tasks}')
        #__________________________________________________________________________________________
        #__________________________________________________________________________________________        
        with open('user.txt','r') as f:
            for line in f:
